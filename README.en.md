...
|---|---:|---|
| Windows Launcher | 1.0.4 | Released |
...
See the [GitHub Release](https://github.com/Hiruynk/RubaTone-AI-Local/releases/tag/v1.0.4) or [Hugging Face file list](https://huggingface.co/hiruynk/RubaTone-AI-Local/tree/main).
